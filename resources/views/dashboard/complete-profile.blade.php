                            ...
                            <div class="card card-bordered">
                                @if (session()->has('msg'))
                                    <div class="alert alert-info"
                                        style="padding:1%; background:green; color:white; font-size:13; margin-bottom:3%; margin-bottm:2%;">
                                        {{ session()->get('msg') }}
                                    </div>
                                @endif
                                <form action="{{ route('dashboard.submit-setup-account') }}" method="post">
                                    @csrf
                                    <div class="nk-kycfm">
                                        ...
                                        <div class="nk-kycfm-content">
                                            <div class="nk-kycfm-note">
                                                ...
                                                <p>
                                                    ...
                                                    your personal details. Your can’t edit these
                                        ...
                                        <div class="nk-kycfm-content">
                                            <div class="nk-kycfm-note">
                                                <em class="icon ni ni-info-fill" data-bs-toggle="tooltip"
                                                    data-bs-placement="right" title="Tooltip on right"></em>
                                                <p>
                                                    Your can’t edit these details once you submitted
                                                    the form.
                                                </p>
                                            </div>
                                            <div class="row g-4">
                                        ...
                                        <div class="nk-kycfm-content">
                                            ...
                                            <ul class="nk-kycfm-control-list g-3">
                                                <li class="nk-kycfm-control-item">
                                                    <input class="nk-kycfm-control" type="radio" name="id-proof"
                                                        id="passport" data-title="Passport" checked /><label
                                                        class="nk-kycfm-label" for="passport"><span
                                                            class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                ...
                                                <li class="nk-kycfm-control-item">
                                                    <input class="nk-kycfm-control" type="radio" name="id-proof"
                                                        id="national-id" data-title="National ID" /><label
                                                        class="nk-kycfm-label" for="national-id"><span
                                                            class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 76 63">
                                                                    <path
                                                ...
                                                <li class="nk-kycfm-control-item">
                                                    <input class="nk-kycfm-control" type="radio" name="id-proof"
                                                        id="driver-licence" data-title="Driving License" /><label
                                                        class="nk-kycfm-label" for="driver-licence"><span
                                                            class="nk-kycfm-label-icon"><span class="label-icon"><svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 76 76">
                                                                    <path
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-control-xs custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="tc-agree"
                                                        required /><label class="custom-control-label" for="tc-agree">I
                                                        Have Read The
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-control-xs custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="info-assure"
                                                        ...
                                                        for="info-assure">All The Personal Information I Have Entered Is
                                                        Correct.</label>
                                                </div>
                                            </div>
