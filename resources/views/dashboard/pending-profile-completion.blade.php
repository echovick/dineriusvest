                    ...
                    <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                        <div class="nk-block-head-content text-center">
                            ...
                            <div class="nk-block-des">
                                <p>
                                    Welcome to our
                                    <strong>Deneriusvest Crypto Dashboard</strong>. You are few
                                    steps away to complete your profile. These are required
                                    to buy and sell on our platform! Let’s start!
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-inner-group">
                                        ...
                                        <div class="card-inner">
                                            <ul class="list list-step">
                                                <li class="list-step-done">
                                                    Verify email address
                                                </li>
                                                <li class="list-step-current">
                                        ...
                                        <div class="align-center flex-wrap flex-md-nowrap g-3 h-100">
                                            <div class="nk-block-image w-200px flex-shrink-0 order-first order-md-last">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114 113.9">
                                                    ...
                                                    <rect x="31" y="27.9" width="48" height="5"
                                                        rx="1" ry="1" fill="#e3e7fe" />
                                                    <rect x="31" y="37.9" width="23" height="3"
                                                        rx="1" ry="1" fill="#c4cefe" />
                                            ...
                                            <div class="nk-block-content">
                                                ...
                                                <p>
                                                    ...
                                                    yet. Please verify yourself to get full access
                                                    to digital wallet.
                                                </p>
