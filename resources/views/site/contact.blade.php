...
@section('title', 'DENARIUSVEST - Contact Us')
                    ...
                    <div class="uk-width-1-1@m uk-margin-large-top">
                        <div class="uk-grid uk-grid-large" data-uk-grid>
                            <div class="uk-width-1-3@m">
                                ...
                                <p class="uk-margin-small-top">info@denariusvest.com<br>+1-702-793-2495</p>
                                <div class="uk-margin-medium-top in-wave-socials-contact">
                                    ...
                                    <a href="#"
                                        class="fab fa-twitter fa-lg uk-text-decoration-none uk-margin-right"></a>
                                    <a href="#"
                                        class="fab fa-linkedin-in fa-lg uk-text-decoration-none uk-margin-right"></a>
                                    <a href="#"
                                        class="fab fa-instagram fa-lg uk-text-decoration-none uk-margin-right"></a>
                                    <a href="#"
                                        class="fab fa-pinterest fa-lg uk-text-decoration-none uk-margin-right"></a>
                                </div>
                            </div>
