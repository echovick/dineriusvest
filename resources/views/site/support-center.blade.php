...
@section('title', 'DENARIUSVEST - Risk Management')
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1 in-content-10">
                        <div class="uk-card uk-card-primary uk-card-body uk-border-rounded uk-background-bottom-left uk-background-contain"
                            style="background-image: url(img/blockit/in-content-10-image.png);">
                        ...
                        <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top"
                            data-uk-grid>
                            <div>
                                <h3 class="uk-heading-bullet"><a class="uk-link-text" href="#">How-tos & Tutorials</a>
                                </h3>
                                <div class="uk-grid uk-grid-small" data-uk-grid>
                                    <div class="uk-width-expand@m">
                                        <p>Whether you're a beginner or an expert, our step-by-step guides will help you navigate our platform effectively and efficiently.</p>
                            ...
                            <div class="uk-visible@m">
                                <h3 class="uk-heading-bullet"><a class="uk-link-text" href="#">Security and
                                        Privacy</a></h3>
                                <div class="uk-grid uk-grid-small" data-uk-grid>
                                    <div class="uk-width-expand@m">
                                        <p>Protecting your data and ensuring your privacy are our top priorities. Our platform is equipped with robust security measures to safeguard your information from any potential threats or breaches, providing you with peace of mind.</p>
                                        <a href="#" class="uk-button uk-button-text">More details</a>
                                    </div>
                                    <div class="uk-width-auto@m">
                                        <div class="in-icon-wrap small transparent uk-margin-left">
                            ...
                            <div>
                                <h3 class="uk-heading-bullet"><a class="uk-link-text" href="#">Open a Support
                                        ticket</a></h3>
                                <div class="uk-grid uk-grid-small" data-uk-grid>
                                    <div class="uk-width-expand@m">
                                        <p>Encountering an issue or need assistance? Our support ticket system is designed to provide you with prompt solutions and assistance. Reach out to our dedicated team, and we'll work tirelessly to address your concerns and ensure a smooth experience for you.</p>
                                        <a href="#" class="uk-button uk-button-text">More details</a>
                                    </div>
                                    <div class="uk-width-auto@m">
                                        <div class="in-icon-wrap small transparent uk-margin-left">
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="img/blockit/in-team-7.png" width="40" height="40"
                                                alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="img/blockit/in-team-8.png" width="40" height="40"
                                                alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="img/blockit/in-team-6.png" width="40" height="40"
                                                alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="img/blockit/in-team-3.png" width="40" height="40"
                                                alt="author-image">
